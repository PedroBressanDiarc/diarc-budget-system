    ...
    <div className="space-y-6">
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            ...
            <form onSubmit={handleCreate}>
              <DialogHeader>
                ...
                <DialogDescription>Adicione um novo item ao estoque</DialogDescription>
              </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Lista completa de todos os itens cadastrados</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={isImporting} onOpenChange={() => {}}>
        <DialogContent className="sm:max-w-md" onInteractOutside={(e) => e.preventDefault()}>
          <DialogHeader>
            <DialogTitle>Importando Itens de Estoque</DialogTitle>
            <DialogDescription>
