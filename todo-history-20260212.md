...
## Conversão Manutenção → Requisição (12/02/2026)
- [ ] Adicionar campos no schema: estimatedPrice (decimal), attachments (JSON com array de URLs)
- [ ] Gerar e aplicar migração SQL para novos campos
- [ ] Implementar lógica de conversão automática ao atingir status "sent_to_purchase"
- [ ] Copiar dados: equipamento, tipo, data, descrição, preço, anexos para requisição
- [ ] Atualizar formulário de criação/edição de manutenção com campo de preço
- [ ] Implementar upload de anexos (fotos, PDFs de cotação) usando S3
- [ ] Exibir anexos na página MaintenanceDetail

## Reorganização do TODO (12/02/2026)
- [ ] Contar linhas de código do projeto (total e por tipo de arquivo)
- [ ] Revisar todo.md completo e marcar tarefas já concluídas
- [ ] Arquivar histórico completo em todo-history.md
- [ ] Criar novo todo.md limpo apenas com pendências
